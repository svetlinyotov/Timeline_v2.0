...
@section('body')
    <div class="box">
        <div class="box-body">
            ...
            <form action="{{asset('users')}}" method="post" enctype="multipart/form-data" class="col-md-6">
                {{csrf_field()}}
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <select name="type" class="form-control">
                            ...
                            @if(Auth::user()->role == "supadmin")
                                <option value="supadmin" {{old('type')=="supadmin"?'selected':null}}>Super admin</option>
                            @endif
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group @if($errors->first("birth_date")) has-error @endif">
                        ...
                        <input type="text" name="birth_date" class="form-control dateinput" value="{{old('birth_date')}}">
                    </div>
