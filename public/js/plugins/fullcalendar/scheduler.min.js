...
(function(factory) {
    ...
    TimelineView = (function(superClass) {
        ...
        TimelineView.prototype.renderDrag = function(dropLocation, seg) {
            if(dropLocation.resourceId != seg.resourceId) return false;
        ...
        TimelineGrid.prototype.renderHeadHtml = function() {
            ...
            for (i = m = 0, len3 = cellRows.length; m < len3; i = ++m) {
                ...
                for (n = 0, len4 = rowCells.length; n < len4; n++) {
                    cell = rowCells[n];
                    html += '' +
                        '<th class="' + this.view.widgetHeaderClass + ' ' + (cell.weekStart ? 'fc-em-cell' : '') + '"' + ' data-date="' + cell.dateData + '"' + (cell.colspan > 1 ? ' colspan="' + cell.colspan + '"' : '') + '>' + '<div class="fc-cell-content">' + '<span class="fc-cell-text">' + htmlEscape(cell.text) + '</span>' + '</div>' + '</th>';
                }
                html += '</tr>';
            }
            html += '</tbody></table>';
            ...
            for (j = 0, len = ref.length; j < len; j++) {
                ...
                contentEl = $('' +
                    '<div class="fc-cell-content">' +
                        ...
                        '</span>' +
                        "<a type='button' class='btn btn-primary btn-xs pull-right' " +
                            "data-toggle='modal' data-target='#add' " +
                            "data-id='"+this.resource.id+"' " +
                            "data-name='"+(text ? htmlEscape(text) : '&nbsp;')+"'><i class='fa fa-plus'></i></a>"+
                    '</div>');
